...
FACE_DET_XML = os.path.join('face-detection-0200/FP16/face-detection-0200.xml')
FACE_DET_BIN = os.path.join('face-detection-0200/FP16/face-detection-0200.bin')
...
HEAD_POSE_XML = os.path.join( 'head-pose-estimation-adas-0001/FP16/head-pose-estimation-adas-0001.xml')
HEAD_POSE_BIN = os.path.join( 'head-pose-estimation-adas-0001/FP16/head-pose-estimation-adas-0001.bin')
